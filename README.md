...
- Guides new users through account setup, session logging, hand capture, session linking, review notes, and backup export.
- Shows recoverable workspace API errors inline with retry and dismiss actions.
